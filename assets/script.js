...
const quickLinkValueEl = document.getElementById("quickLinkValue");
...
button.onclick = function cityLookUp() {
  ...
  fetch(queryURL).then(function (response) {
              ...
              fetch(fiveDayForecast).then(function (response) {
                if (response.ok) {
                  ...
                  response.json().then(function (data) {
                    ...
                    //day one display
                    dayOneEl.innerHTML = new Date(dayOne).toLocaleDateString(
                      "en-us",
                      {
                        weekday: "long",
                        year: "numeric",
                    ...
                    //day two display
                    dayTwoEl.innerHTML = new Date(dayTwo).toLocaleDateString(
                      "en-us",
                      {
                        weekday: "long",
                        year: "numeric",
                    ...
                    dayThreeTempEl.innerHTML =
                      "Temp: " + k2f(dayThreeTemp) + "&#176F";
                    windThreeEl.innerHTML = "Wind Speed: " + dayThreeWind;
                    humidityThreeEl.innerHTML =
                      "Humidity: " + humidityThree + "%";
                    dayThreePicEl.setAttribute(
                      "src",
                      "https://openweathermap.org/img/wn/" +
                        weatherPicThree +
                        "@2x.png"
                    ...
                    //day four display
                    dayFourEl.innerHTML = new Date(dayFour).toLocaleDateString(
                      "en-us",
                      {
                        weekday: "long",
                        year: "numeric",
                    ...
                    dayFourTempEl.innerHTML =
                      "Temp: " + k2f(dayFourTemp) + "&#176F";
                    windFourEl.innerHTML = "Wind Speed: " + dayFourWind;
                    humidityFourEl.innerHTML =
                      "Humidity: " + humidityFour + "%";
                    dayFourPicEl.setAttribute(
                      "src",
                      "https://openweathermap.org/img/wn/" +
                        weatherPicFour +
                        "@2x.png"
                    ...
                    //day five display
                    dayFiveEl.innerHTML = new Date(dayFive).toLocaleDateString(
                      "en-us",
                      {
                        weekday: "long",
                        year: "numeric",
                    ...
                    dayFiveTempEl.innerHTML =
                      "Temp: " + k2f(dayFiveTemp) + "&#176F";
                    windFiveEl.innerHTML = "Wind Speed: " + dayFiveWind;
                    humidityFiveEl.innerHTML =
                      "Humidity: " + humidityFive + "%";
                    dayFivePicEl.setAttribute(
                      "src",
                      "https://openweathermap.org/img/wn/" +
                        weatherPicFive +
                        "@2x.png"
    ...
    const quickLinkButton = document.getElementById("quickLinks");
    quickLinkButton.onclick = function quickLookUp() {
      cityLookUp(quickLinkValueEl.value);
    };
